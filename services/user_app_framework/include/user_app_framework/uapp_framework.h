...
#if defined(CONFIG_IA_USER_APP_FRAMEWORK)
#include <app_memory/app_memdomain.h>
#endif
#include <user_app_framework/uapp_utils.h>
...
#define USER_MODE_APP BIT(0)
#define USER_MODE_SERVICE BIT(1)

#define K_PART_GLOBAL BIT(2)
#define K_PART_SHARED BIT(3)
 ...
 * USER_MODE_SERVICE then app Main thread will scheduled to execution
 **immidiately
 ...
 *
 */
#define DEFINE_USER_MODE_APP(app_id, app_mode, app_main_task, stack_sizes, \
			     kobj_list, total_obj, config_cb)		   \
...
#define GET_APP_MAIN_THREAD_ID(app_id) &app##app_id##_tid
...
#define APP_GLOBAL_VAR(app_id) K_APP_DMEM(uafw_part##app_id)

#define APP_GLOBAL_VAR_BSS(app_id) K_APP_BMEM(uafw_part##app_id)

#define APP_SHARED_VAR K_APP_DMEM(uafw_part9)

#define APP_SHARED_VAR_BSS K_APP_BMEM(uafw_part9)
#else
