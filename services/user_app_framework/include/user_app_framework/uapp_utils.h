...
#define USER_APP_UTIL_NOT(x) \
	USER_APP_UTIL_CHECK(USER_APP_UTIL_PRIMITIVE_CAT(USER_APP_UTIL_NOT_, x))

#define USER_APP_UTIL_NOT_0 ~, 1,

#define USER_APP_UTIL_COMPL(b) \
	USER_APP_UTIL_PRIMITIVE_CAT(USER_APP_UTIL_COMPL_, b)
...
#define USER_APP_UTIL_EXPAND(...) __VA_ARGS__
#define USER_APP_UTIL_WHEN(c) \
	USER_APP_UTIL_IF(c) (USER_APP_UTIL_EXPAND, USER_APP_UTIL_EAT)
...
#define USER_APP_UTIL_REPEAT(count, macro, ...)			   \
	...
	(USER_APP_UTIL_OBSTRUCT(USER_APP_UTIL_REPEAT_INDIRECT) ()( \
	 ...
	 USER_APP_UTIL_OBSTRUCT(macro) (USER_APP_UTIL_DEC(count),  \
					__VA_ARGS__))
#define USER_APP_UTIL_REPEAT_INDIRECT() USER_APP_UTIL_REPEAT

#define USER_APP_UTIL_LISTIFY(LEN, F, F_ARG) \
	USER_APP_UTIL_EVAL(USER_APP_UTIL_REPEAT(LEN, F, F_ARG))
