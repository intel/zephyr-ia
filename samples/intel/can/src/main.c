 ...
 * List of supported baud rates of CAN
 */
...
void send_std_message(const struct device *dev, uint32_t id)
{
	...
	printk("inside send std message\n");
...
void main(void)
{
	...
	printk("CAN Test Application\n");
	can_dev[0] = device_get_binding("CAN_0");
